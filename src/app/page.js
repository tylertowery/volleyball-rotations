...
export default function Home() {
  ...
  const getPlayerPositionsArray = (numPlayers) => {
    if (numPlayers === 6) {
      ...
      return ['bottom-right', 'extra-5', 'top-right', 'top-middle', 'top-left', 'bottom-left', 'bottom-middle'];
    } else if (numPlayers === 8) {
      return ['bottom-right', 'extra-4', 'extra-5', 'top-right', 'top-middle', 'top-left', 'bottom-left', 'bottom-middle'];
    } else if (numPlayers === 9) {
      return ['bottom-right', 'extra-3', 'extra-4', 'extra-5', 'top-right', 'top-middle', 'top-left', 'bottom-left', 'bottom-middle'];
    } else if (numPlayers === 10) {
      return ['bottom-right', 'extra-2', 'extra-3', 'extra-4', 'extra-5', 'top-right', 'top-middle', 'top-left', 'bottom-left', 'bottom-middle'];
